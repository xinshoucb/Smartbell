...
//                    Looper.prepare();
    ...
    int count = 0;
    String[] testData = {"#334","#201","#2d2","#2d2","#200","#2d0","#2d5","#300","#500","#600","#400","#336","#359","#2011","#2d22","#2d23","#2004","#2d05","#2d56","#3007","#5060","#6040"};//, "#2d2", "#303", "#334", "#405", "#506", "-2d2", "-334", "#603", "#702", "-405", "-506", "#aa6", "#A23", "#d02", "-702", "-702"};
